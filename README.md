...
* Gradle dependency: `implementation("ru.pixnews.wasm-sqlite-open-helper:sqlite-android-wasm-emscripten-icu-346:0.1")`
* Debug binaries: [sqlite-android-wasm-emscripten-icu-346-3460000-debug.zip](https://github.com/illarionov/wasm-sqlite-driver-binary/releases/download/0.1/sqlite-android-wasm-emscripten-icu-346-3460000-debug.zip)
...
* Gradle dependency: `implementation("ru.pixnews.wasm-sqlite-open-helper:sqlite-android-wasm-emscripten-icu-mt-pthread-346:0.1")`
* Debug binaries: [sqlite-android-wasm-emscripten-icu-mt-pthread-346-3460000-debug.zip](https://github.com/illarionov/wasm-sqlite-driver-binary/releases/download/0.1/sqlite-android-wasm-emscripten-icu-mt-pthread-346-3460000-debug.zip)
...
* Gradle dependency: `implementation("ru.pixnews.wasm-sqlite-open-helper:sqlite-wasm-emscripten-346:0.1")`
* Debug binaries: [sqlite-wasm-emscripten-346-3460000-debug.zip](https://github.com/illarionov/wasm-sqlite-driver-binary/releases/download/0.1/sqlite-wasm-emscripten-346-3460000-debug.zip)
...
* Gradle dependency: `implementation("ru.pixnews.wasm-sqlite-open-helper:sqlite-wasm-emscripten-mt-pthread-346:0.1")`
* Debug binaries: [sqlite-wasm-emscripten-mt-pthread-346-3460000-debug.zip](https://github.com/illarionov/wasm-sqlite-driver-binary/releases/download/0.1/sqlite-wasm-emscripten-mt-pthread-346-3460000-debug.zip)
...
Gradle dependency:
```
implementation("ru.pixnews.wasm-sqlite-open-helper:wasm-binary-reader:0.1")
```
...
dependencies {
    implementation("ru.pixnews.wasm-sqlite-open-helper:wasm-binary-reader:0.1")
    implementation("ru.pixnews.wasm-sqlite-open-helper:sqlite-android-wasm-emscripten-icu-mt-pthread-346:0.1")
}
```
